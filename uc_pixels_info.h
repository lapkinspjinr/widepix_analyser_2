...
public :
    ...
    typedef enum {
        ...
        UTE_PA_roi_thlid1_thlid2,    ///< Не переполненные и немаскированные пиксели в области интереса
        UTE_PA_roi_thlid3_thlid4,    ///< Не переполненные и немаскированные пиксели в области интереса
    } UTE_pixels_area;
...
private :
    ...
    double id_1_data_1;                     ///< Отношение сигнал - шум
    double id_1_data_2;                     ///< Отношение сигнал - шум
...
public :
    ...
    void U_add_pixel_id_1(double z);
    void U_add_pixel_id_2(double z);
